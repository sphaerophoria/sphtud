...
fn HttpReaderGeneric(comptime Header: type) type {
    return struct {
        ...
        // FIXME: API should allow bypassing allocations if we can handle them
        // before reading from the body reader
        pub fn poll(self: *Self, alloc: std.mem.Allocator, body_buf: []u8) !Result {
            ...
            while (true) {
                ...
                // FIXME: This feels quite duplicated with the request reader
...
// FIXME: Capture some request/responses from a few places and throw them in a test
// Variety
//   * Someone who responds with content length
//   * Someone who responds with remaining
//   * Someone who responds with chunked data
